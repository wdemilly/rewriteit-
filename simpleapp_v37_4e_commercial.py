...
MAX_REGEN_ITERATIONS = 3      # v37.4d: was 8. The v37.4c scanner-veto
                              # restoration makes more drafts FAIL hard_cap_pass,
                              # which under COMMERCIAL_ALWAYS_STAGE_G_ON_HARDCAP_FAIL
                              # + this loop fires more iterations. At 8 the worst
                              # case was 8 x repetitions full Opus-4.7 drafts per
                              # chapter; scan-history data shows iters past ~3
                              # rarely reach ship band and mostly exhaust to
                              # best-observed. 3 keeps one real temp-bumped retry
                              # while capping cost ~3x. Tune up if a register needs
                              # more retries to clear the restored gate.
