...
# Constants
# ============================================================================
APP_VERSION = "v37.4b-commercial"
# v37.4b — single-bug fix to v37.4a. Two references to a non-existent
# `_scan_summary` function inside the local-scorer block of run_pipeline
# (lines 4213, 4286 in v37.4a) caused score_text() to raise
# NameError at runtime, which the local-scorer try/except caught as
# SCORER_CRASHED. Result: the AI-score gate, Stage G line-edit pass, and
# the regen loop never ran on any batch in v37.4a. The intended function
# is `format_scan_summary` (defined at line 1168), already used correctly
# at three other call sites. Renamed both references to the correct
# function name. No other behavior changes from v37.4a.
